...
public class C1406_CreateACondoRentMustSeeListing extends Base_Test {
	...
	@Test
	public void C1406_CreateACondoRentMustSee_Listing() throws Exception {
		...
		if (util.verifyLogin()) {
			 ...
			 lc.Click_PostalCode();
			 driver.findElement(By.xpath("//*[@id='etSearchLocation']")).sendKeys("One Amber");
			 lc.Click_Result();
			 lc.Click_BtRent();
			 lc.Click_UnitNumber();
			 ...
			 try {
					...
					System.out.println("#Then my Must See listing for Condo/Rent would be submitted for approval");
