...
public class C1408_CreateALandedRentMustSeeListing extends Base_Test {
	...
	@Test
	public void C1408_CreateALandedRentMustSee_Listing() throws Exception {
		...
		System.out.println("\n");
		System.out.println("TestCase : C1408");	
		System.out.println("Create a Landed/Rent Must See listing");	
		System.out.println("---------");		 
		...
		if (util.verifyLogin()) {
			 ...
			 lc.Click_PostalCode();
			 driver.findElement(By.xpath("//*[@id='etSearchLocation']")).sendKeys("820 MountBatten Road");
			 lc.Click_Result();
			 lc.Click_BtRent();
			 driver.swipe(620, 1114, 604, 235, 2845);
			 ...
			 lc.Click_3Bathrooms();
			 lc.Click_FeatureDateOfA();
			 lc.Click_31July();
			 lc.Click_FeaturesOk();
			 lc.Click_FeatureFurnishing();
			 lc.Click_FullyFurnished();
			 ...
			 try {
					...
					System.out.println("#Then my Must See listing for Landed/Rent would be submitted for approval");
