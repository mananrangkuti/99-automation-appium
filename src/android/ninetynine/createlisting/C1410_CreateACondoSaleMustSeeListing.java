...
public class C1410_CreateACondoSaleMustSeeListing extends Base_Test {
	...
	@Test
	public void C1410_CreateACondoSaleMustSee_Listing() throws Exception {
		...
		System.out.println("\n");
		System.out.println("TestCase : C1410");	
		System.out.println("Create a Condo/Sale Must See listing");	
		System.out.println("---------");		 
		...
		if (util.verifyLogin()) {
			 ...
			 lc.Click_PostalCode();
			 driver.findElement(By.xpath("//*[@id='etSearchLocation']")).sendKeys("Reflections At Keppel Bay");
			 lc.Click_Result();
			 lc.Click_BtSale();
			 lc.Click_UnitNumber();
			 ...
			 try {
					...
					System.out.println("#Then my Must See listing for Condo/Sale would be submitted for approval");
